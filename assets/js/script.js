(function ($) {
  ...
  //Donate One Left Carousel
  if ($(".donate-one-left__carousel").length) {
    $(".donate-one-left__carousel").owlCarousel({
      loop: true,
      margin: 30,
      nav: false,
      dots: false,
  ...
  //Donate One Right Carousel
  if ($(".donate-one-right__carousel").length) {
    $(".donate-one-right__carousel").owlCarousel({
      loop: true,
      margin: 30,
      nav: false,
      dots: false,
  ...
  if ($(".footer-widget__carousel").length) {
    $(".footer-widget__carousel").owlCarousel({
      loop: true,
      margin: 0,
      nav: false,
      dots: true,
